...
mouse=qread("/rds/general/project/hda_students_data/live/Group7/General/Eleonore/thesis/aled/mouse_se_filtered.qs")
...
test <- trainModel_new(test, model='rf')
# mouse
test
saveRDS(test,'mouse_model_SMOTE_rf2.rds')
...
test=readRDS('mouse_model_SMOTE_rf2.rds')
#### cell classification
...
#
qsave(query ,'/rds/general/user/ems2817/home/thesis/clara_aim12/fun/query2_rf2_aim11.qs')
#query=qread('query2_rf.qs')
...
feature=FeaturePlot(query, features=c("scpred_1","scpred_2","scpred_3","scpred_4"), keep.scale=NULL,dims = c(1, 2))
FeaturePlot(query, "scpred_1")
FeaturePlot(query, "scpred_2")
FeaturePlot(query, "scpred_3")
FeaturePlot(query, "scpred_4")
ggsave("feature-rf2_aim11.png", feature, height = 5, width = 7, dpi = 320)
