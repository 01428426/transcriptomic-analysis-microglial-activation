...
seu=qread('/rds/general/project/hda_students_data/live/Group7/General/Eleonore/thesis/clara_aim12/obj_clusters_manifest_20pcs.qs')
...
sce_subset$cluster=seu_subset@meta.data$integrated_snn_res.0.01
