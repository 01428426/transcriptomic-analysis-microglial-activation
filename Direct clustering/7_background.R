...
seu_micro_pc=qread('/rds/general/project/hda_students_data/live/Group7/General/Eleonore/thesis/new_aim11/obj_clusters_20pcs.qs')
DefaultAssay(seu_micro_pc) <- "integrated"
Idents(object = seu_micro_pc) <- "integrated_snn_res.0.015"


system.time(background_gene_all_l <- PrctCellExpringGene(object = seu_micro_pc,
                                                         genes = rownames(seu_micro_pc),
                                                         group.by = "integrated_snn_res.0.015"))
...
save(background_gene_all_l, background_gene_all,
     file = "/rds/general/project/hda_students_data/live/Group7/General/Eleonore/thesis/new_aim11/background_genes_exprsd_0.25prct_cell.rda")